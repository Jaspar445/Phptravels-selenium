...
public class BrowserFactory {
    ...
    private final static String MESSAGE_UNKNOWN_BROWSER = "Unknown browser type! Please check your configuration";
    ...
    //getBrowser method returns WebDriver object
    public WebDriver getBrowser() {

        //Check if it's running remotely or locally
        if(isRemoteRun) {
            //Create DesiredCapabilities objet needed to select browser
    ...
    //getRemoteWebDriver method returns RemoteWebDrivera object based on the desiredCapabilities object
